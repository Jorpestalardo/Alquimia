                    ...
                    <ul>
                        @if (auth()->user()->roles_id == 1)
                            <li class="menu-item sub-menu">
                                <a class="nav-link" href=" {{ route('admin.blog.dashboardBlog') }}">
                                    <span class="menu-title">Administrar Blogs</span>
                            ...
                            <li class="menu-item sub-menu">
                                <a class="nav-link publicar" href=" {{ route('admin.empresas.formEmpresa') }}">
                                    <span class="menu-title">Publicar la nueva empresa</span>
                                    <span class="menu-icon">
